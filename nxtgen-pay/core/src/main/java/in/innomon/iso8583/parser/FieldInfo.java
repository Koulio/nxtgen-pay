...
public interface FieldInfo extends Cloneable {
    // we have got enum rather than a fine grain classes so as to reduce number of new class ctors
    // per message parsing. Creating new classes adds to overheads.
    public enum Format {LLVAR,LLLVAR, FIXED,YYMM,YYMMDD, DDMMYY, MMDDhhmmss, YYMMDDhhmmss };
    public enum Attribute {ALPHA, ALNUM, ALNUMPAD, ALPHA_OR_NUM, NUM,SIGN_NUM, ALNUMSPECIAL, SPECIAL, BIN};
