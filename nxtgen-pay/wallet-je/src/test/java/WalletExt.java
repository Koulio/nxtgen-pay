...
import in.innomon.xml.NamespaceContextImpl;
 ...
 */
@XmlRootElement
public class WalletExt extends WalletBase {

    public static final String NS = "http://xml.qzip.in/pay/v01";
    private String mmid;

    public WalletExt() {
    }

    public WalletExt(String mmid, String accountId, String currency) {
