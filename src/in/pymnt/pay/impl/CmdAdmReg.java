 ...
 * @author ashish
 * 
 * ADMIN REG <Mobile> <KYC PIN>
 */
public class CmdAdmReg extends CmdAdminBase {
     private Pattern patNums = Pattern.compile("[0-9]*");

    public CmdAdmReg() {
        cmdName = "REG";
        help = "Registers a mobile, usage: REG <Mobile> <KYC PIN>";
    }
    @Override
    public String exec(String cmdLine, Context cmdCtx) {
        ...
        String ret = "OK";
        try {
            helper.register(mobile,Integer.parseInt(kycPin));
