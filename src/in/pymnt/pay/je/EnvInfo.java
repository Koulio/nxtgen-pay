...
public class EnvInfo {
    ...
    private String balanceStore = "Balance";
    private String accountInfoStore = "AccountInfo";
    private String txnStore = "TxnStore";
    private boolean createAccountOnTxn = false;  // create a new UUID if not present

    // replication support
    private String groupName = "payReplicationGroup";
    ...
    public String getAccountInfoStore() {
        return accountInfoStore;
    }

    public void setAccountInfoStore(String accountInfoStore) {
