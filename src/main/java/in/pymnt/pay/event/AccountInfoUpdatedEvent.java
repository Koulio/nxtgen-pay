...
/**
 * TODO: Implement a common Abstract Event<T> class
 * @author ashish
 */
public class AccountInfoUpdatedEvent implements Event {

    private AccountInfo act;
    ...
    public AccountInfoUpdatedEvent(AccountInfo act) {
        this.act = act;
    }
