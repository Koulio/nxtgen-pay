...
import in.pymnt.pay.txn.TxnRes;
...
public  class AdminCmdHelperImpl implements AdminCmdHelper {
    ...
    private String defaultMMID = Globals.prop.getProperty(Globals.MMID_PROPNAME, "7654321");  // MMID is 7 digits, 4 digits are used by NPCI for routing, 3 are in control of the bank
