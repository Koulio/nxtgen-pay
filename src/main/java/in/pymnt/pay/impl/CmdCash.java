...
import in.pymnt.pay.xmpp.XmppConstants;
import in.pymnt.pay.xmpp.XmppMsgNotifier;
...
public class CmdCash extends CmdAdminBase {
    ...
    private Pattern patCash = Pattern.compile("[0-9]{1,4}(\\.[0-9]{1,2})?");
    private Pattern patMmid = Pattern.compile("[0-9]{7}");
    private Pattern patMobile = Pattern.compile("[0-9]{10}");
    private Pattern patOtp = Pattern.compile("[0-9]{6}");
