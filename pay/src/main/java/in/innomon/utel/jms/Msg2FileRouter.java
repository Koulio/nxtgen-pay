 ...
 * @author ashish
 */
public class Msg2FileRouter implements MessageListener{
    transient Logger logger = null;
    private String loggerName = "JIO";
    private String outDir = "./";
    private String outFilePrefix = "JMS-";
    private String outFilePostfix = ".txt";
    ...
    public void onMessage(Message msg) {
        try {
            ...
            File fl = new File(outDir, outFilePrefix+System.nanoTime()+outFilePostfix);
